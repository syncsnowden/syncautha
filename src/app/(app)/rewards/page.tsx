                ...
                {activeProvider === "linkvertise" ? (
                  <div className="card">
                    ...
                    <div className="card-body" style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                        <span style={{ fontSize: 11, color: "var(--text-2)", fontWeight: 600 }}>Option A: Direct Redirect (Vulnerable to bypasses)</span>
                        <p style={{ fontSize: 11, color: "var(--text-3)", margin: "0 0 4px 0" }}>Set target URL in Linkvertise to your key generation page.</p>
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                        <span style={{ fontSize: 11, color: "var(--text-2)", fontWeight: 600 }}>Option B: Postback Endpoint Redirect (Recommended & Secure)</span>
